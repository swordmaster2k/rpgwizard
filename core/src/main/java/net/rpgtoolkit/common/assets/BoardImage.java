...
public class BoardImage implements Cloneable {
   ...
   * 
   * @param boundLeft left bound of image
   */
   ...
   * 
   * @param boundTop top bound of image
   */
   ...
   * 
   * @param transparentColour transparent colour
   */
   ...
   * 
   * @param canvasPointer canvas pointer
   */
   ...
   * 
   * @param scrollX amount to shift in x
   */
   ...
   * 
   * @param scrollY amount to shift in y
   */
