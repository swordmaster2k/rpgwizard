...
public class StatusEffectAttribute {
   ...
   * user-defined names while all other attribute kinds have predefined names.
   *
   ...
   * @return duration # of rounds). A duration less than or equal to 0 implies the
   ...
   *
   * @param value (# of rounds). A duration less than or equal to 0 implies the
   *              effect remains until explicitly removed.
   */
  ...
  /**
   * Gets the magnitude of the status effect attribute. The magnitude is the strength or impact of
   * the effect whose behavior is dependent on the {@link StatusEffectAttributeKind}
   * of the attribute.
   *
   ...
   *
   * @see #getMagnitude
   * @param value magnitude (in units)
   */
