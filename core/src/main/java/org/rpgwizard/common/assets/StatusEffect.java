...
/**
 * Status Effect that can be applied to an entity, and may affect gameplay inside or outside of battle.
 *
...
public class StatusEffect extends AbstractAsset {
    ...
    /**
     * Returns a collection of attributes applied to a target when the status effect is given to a target.
     *
