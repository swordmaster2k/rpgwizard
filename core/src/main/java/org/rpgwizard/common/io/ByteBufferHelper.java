 ...
 */
package org.rpgwizard.common.io;
...
public final class ByteBufferHelper {
    ...
    /**
     * Converts a String to bytes using the legacy character set and returns a new buffer containing the String's bytes,
     * with its position at 0, ready to write.
     *
     * @param s
