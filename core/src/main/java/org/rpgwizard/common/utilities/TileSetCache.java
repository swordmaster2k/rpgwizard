...
public class TileSetCache {
    ...
    /**
     * Allows the calling object to check if the tile set has already been loaded, this should be checked before calling
     * loadTileSet
     *
     * @param key
     *            Tile Set file to check for
    ...
    /**
     * Adds the specified tile set into the cache, it will only load the file if it is not already present in the cache,
     * it is important to call contains(String key) before calling this method.
     *
     * @param fileName
     *            Tile set to attempt to load into the cache
