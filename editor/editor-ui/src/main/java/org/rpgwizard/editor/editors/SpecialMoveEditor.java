...
public final class SpecialMoveEditor extends AbstractAssetEditorWindow implements InternalFrameListener {
    ...
    private void createSpecialMovePanel() {
        ...
        editorPanel.setBorder(BorderFactory.createTitledBorder(this.defaultEtchedBorder, "Special Move Editor"));
        ...
        editorLayout.setHorizontalGroup(editorLayout.createParallelGroup()
                .addGroup(editorLayout.createSequentialGroup().addComponent(moveNameLabel).addComponent(this.moveName))
                .addGroup(editorLayout.createSequentialGroup().addComponent(descriptionLabel)
                        .addComponent(this.description))
                .addGroup(editorLayout.createSequentialGroup().addComponent(mpCostLabel).addComponent(this.mpCost))
                .addGroup(editorLayout.createSequentialGroup().addComponent(fightPowerLabel)
                        .addComponent(this.fightPower))
                .addGroup(editorLayout.createSequentialGroup().addComponent(mpRemovedTargetLabel)
                        .addComponent(this.mpRemovedTarget))
                .addGroup(editorLayout.createSequentialGroup().addComponent(statusEffectLabel)
                        .addComponent(this.statusEffect).addComponent(statusEffectButton))
                .addGroup(editorLayout.createSequentialGroup().addComponent(animationLabel).addComponent(this.animation)
                        .addComponent(animationButton))
                .addGroup(editorLayout.createSequentialGroup().addComponent(programLabel).addComponent(this.program)
                        .addComponent(programButton))
                .addComponent(this.battleDriven).addComponent(this.boardDriven));

        editorLayout.linkSize(SwingConstants.HORIZONTAL, moveNameLabel, descriptionLabel, mpCostLabel, fightPowerLabel,
                mpRemovedTargetLabel, statusEffectLabel, animationLabel, programLabel);

        editorLayout.setVerticalGroup(editorLayout.createSequentialGroup()
                .addGroup(editorLayout.createParallelGroup().addComponent(moveNameLabel).addComponent(this.moveName,
                        GuiHelper.JTF_HEIGHT, GuiHelper.JTF_HEIGHT, GuiHelper.JTF_HEIGHT))
                .addGroup(editorLayout.createParallelGroup().addComponent(descriptionLabel)
                        .addComponent(this.description))
                .addGroup(editorLayout.createParallelGroup().addComponent(mpCostLabel).addComponent(this.mpCost))
                .addGroup(
                        editorLayout.createParallelGroup().addComponent(fightPowerLabel).addComponent(this.fightPower))
                .addGroup(editorLayout.createParallelGroup().addComponent(mpRemovedTargetLabel)
                        .addComponent(this.mpRemovedTarget))
                .addGroup(editorLayout.createParallelGroup().addComponent(statusEffectLabel)
                        .addComponent(this.statusEffect).addComponent(statusEffectButton))
                .addGroup(editorLayout.createParallelGroup().addComponent(animationLabel).addComponent(this.animation)
                        .addComponent(animationButton))
                .addGroup(editorLayout.createParallelGroup().addComponent(programLabel).addComponent(this.program)
                        .addComponent(programButton))
                .addComponent(this.battleDriven).addComponent(this.boardDriven));

        editorLayout.linkSize(SwingConstants.VERTICAL, this.moveName, this.description, this.mpCost, this.fightPower,
                this.mpRemovedTarget, this.statusEffect, this.animation, this.program);

        // Configure BASIC SETTINGS PANEL layout
        layout.setHorizontalGroup(layout.createParallelGroup().addComponent(editorPanel, 515, 515, 515));

        layout.setVerticalGroup(layout.createSequentialGroup().addComponent(editorPanel));
    }
