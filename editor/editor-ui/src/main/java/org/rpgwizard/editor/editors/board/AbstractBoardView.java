 ...
 * management. It does NOT perform the actual rendering of the board it only defines abstract methods that a sub class
 * can use, this is due to the fact that the Toolkit supports both flat 2D boards and isometric boards.
 *
 * @author Joshua Michael Daly
 */
public abstract class AbstractBoardView extends JPanel implements MultiLayerContainer, BoardChangeListener {
    ...
    /**
     * Checks that the x and y tile based coordinates are within the bounds of the board.
     *
     * @param x
     *            tile coordinate
     * @param y
