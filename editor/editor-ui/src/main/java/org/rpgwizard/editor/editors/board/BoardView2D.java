...
/**
 * A concrete class for drawing 2D RPG-Toolkit Boards, this is the view component. It defines the actual code behind its
...
public final class BoardView2D extends AbstractBoardView {
    ...
    /**
     * Handles the drawing of the grid on the graphics context. It draws a grid based on the boards width and height in
     * tiles.
     *
    ...
    protected void paintGrid(Graphics2D g) {
        ...
        GuiHelper.drawGrid(g, board.getTileWidth(), board.getTileHeight(), clipRectangle);
    }
    ...
    /**
     * Handles the drawing of the coordinates on the graphics context. It draws a coordinates based on the boards width
     * and height in tiles.
     *
