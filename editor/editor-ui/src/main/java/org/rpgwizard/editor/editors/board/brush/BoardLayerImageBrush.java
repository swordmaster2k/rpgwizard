...
public class BoardLayerImageBrush extends AbstractBrush {
    ...
    public void doMouseButton3Pressed(Point point, AbstractAssetEditorWindow editor) {
        if (editor instanceof BoardEditor) {
            ...
            BoardLayerImage image = boardEditor.getBoardView().getCurrentSelectedLayer().getLayer().findImageAt(point.x,
    ...
    public boolean equals(Brush brush) {
        return brush instanceof BoardLayerImageBrush
                && ((BoardLayerImageBrush) brush).boardLayerImage.equals(boardLayerImage);
    }
