...
public abstract class AbstractSpriteModelPanel extends AbstractModelPanel {
    ...
    public AbstractSpriteModelPanel(AbstractSprite model) {
        ...
        horizontalGroup.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addComponent(baseVectorWidthSpinner).addComponent(baseVectorHeightSpinner)
                .addComponent(baseVectorOffsetXSpinner).addComponent(baseVectorOffsetYSpinner)
                .addComponent(activationVectorWidthSpinner).addComponent(activationVectorHeightSpinner)
                .addComponent(activationVectorOffsetXSpinner).addComponent(activationVectorOffsetYSpinner));
