...
/**
 * This Enum exits to make refactoring editor properties in the .properties file
 * easier.
 *
...
public enum EditorProperty {
	...
	EDITOR_BUILDS_DIRECOTRY("editor.builds.directory"), EDITOR_JRE_DIRECOTRY(
			"editor.jre.directory"), EDITOR_PLUGINS_DIRECOTRY(
			"editor.plugins.directory"),

	// Tooltips
	EDITOR_UI_TOOLTIP_NEW("editor.ui.tooltip.new"), EDITOR_UI_TOOLTIP_OPEN(
			"editor.ui.tooltip.open"), EDITOR_UI_TOOLTIP_SAVE(
			"editor.ui.tooltip.save"), EDITOR_UI_TOOLTIP_SAVE_ALL(
