...
/**
 * A field that consists of a JFormattedTextField with a default formatter that ensures it contains integers. (-2, -1,
 * 0, 1, 2, etc.) Use any time you want a text field in which the user should enter only integers.
 *
 * @author Joel Moore
 */
