...
public class CompileAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            SwingWorker<File, File> worker = new SwingWorker<>() {
                @Override
                protected File doInBackground() {
                    try {
                        File executionPath = new File(FileTools.getExecutionPath(MainWindow.class));
                        return compileGame(project, projectCopy, executionPath, progressMonitor);
    ...
    private File compileGame(Game project, File projectCopy, File executionPath, ProgressMonitor progressMonitor)
