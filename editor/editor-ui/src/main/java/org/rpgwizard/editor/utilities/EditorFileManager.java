...
public class EditorFileManager {
	...
	public static String getTypeFilterDescription(
			Class<? extends AbstractAsset> type) {
		if (type == Animation.class) {
			return "Animations";
		} else if (type == Board.class) {
			return "Boards";
	...
	public static String[] getTKFileExtensions() {
		return CoreProperties.getProperty("toolkit.supported.extensions")
				.split(",");
	}
	...
	public static String[] getTypeExtensions(Class<? extends AbstractAsset> type) {
		if (type == Animation.class) {
			return new String[]{CoreProperties
					.getProperty("toolkit.animation.extension.default")};
		} else if (type == Board.class) {
			return new String[]{CoreProperties
					.getProperty("toolkit.board.extension.default")};
		} else if (type == Enemy.class) {
			return new String[]{CoreProperties
			...
			return new String[]{CoreProperties
					.getProperty("toolkit.statuseffect.extension.default")};
		} else if (type == TileSet.class) {
			return new String[]{CoreProperties
					.getProperty("toolkit.tileset.extension.default")};
		} else if (type == SpecialMove.class) {
			return new String[]{CoreProperties
					.getProperty("toolkit.specialmove.extension.default")};
		} else {
	...
	public static void openFile() {
		setFileChooserSubdirAndFilters("", "Toolkit Files",
				getTKFileExtensions());
		if (FILE_CHOOSER.showOpenDialog(MainWindow.getInstance()) == JFileChooser.APPROVE_OPTION) {
			MainWindow.getInstance().openAssetEditor(
					FILE_CHOOSER.getSelectedFile());
		}
	}

	public static void openFile(String path, String description,
			String[] extensions) {
	 ...
	 *         subdirectory corresponding to that type; or null if no file or an
	 *         invalid file is selected (see browseLocationBySubdir())
	 */
	public static String browseByTypeRelative(
			Class<? extends AbstractAsset> type) {
	 ...
	 * @return the location of the file the user selects, relative to the
	 *         subdirectory corresponding to that type; or null if no file or an
	 *         invalid file is selected (see saveLocationBySubdir())
	 */
	 ...
	 * @param extensions
	 *            the file extensions to filter by (the portion of the file name
	 *            after the last ".")
	 * @return the location of the file the user selects; or null if no file or
	 *         an invalid file is selected
	 */
	public static File browseLocationBySubdir(String subdirectory,
	 ...
	 *         an invalid file is selected
	 */
	public static File[] browseLocationBySubdirMultiSelect(String subdirectory,
			String description, String... extensions) {
	 ...
	 *         an invalid file is selected
	 */
	public static File saveLocationBySubdir(String subdirectory,
			String description, String... extensions) {
		File path = setFileChooserSubdirAndFilters(subdirectory, description,
				extensions);
	 ...
	 * @return
	 */
	public static File setFileChooserSubdirAndFilters(String subdirectory,
			String description, String... extensions) {
	 ...
	 *
	 * @param extensions
	 *            the file is required to end with one of these (do not include
	 *            the dot that comes immediately before the extension)
	 * @param path
	 *            the location will be relative to this path
	 * @return the location of the currently selected file of one of the given
	 *         extensions, relative to the given path; or null if the extension
	 *         does not match
	 */
