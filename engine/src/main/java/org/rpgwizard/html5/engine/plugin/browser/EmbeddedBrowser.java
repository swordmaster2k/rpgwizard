...
public final class EmbeddedBrowser extends JFrame {
    ...
    public EmbeddedBrowser(String title, String startURL, boolean useOSR, boolean isTransparent) {
        ...
        cefClient.addLoadHandler(new CefLoadHandler() {
                        ...
                        if (event.windows_key_code == KeyEvent.VK_F12) {
                            if (event.type == CefKeyboardHandler.CefKeyEvent.EventType.KEYEVENT_RAWKEYDOWN) {
                                if (devToolsUI == null) {
                                    ...
                                    devToolsUI.setPreferredSize(new Dimension(1000, 200));
            ...
            @Override
            public void onLoadError(CefBrowser arg0, int arg1, CefLoadHandler.ErrorCode arg2, String arg3, String arg4) {
            }
        });
